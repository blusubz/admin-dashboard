...
A clean, responsive admin dashboard interface built as part of [The Odin Project](https://www.theodinproject.com/) curriculum to practice modern CSS layout techniques using CSS Grid and Flexbox.

🚀 **[View Live Demo](https://blusubz.github.io/admin-dashboard/)**
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/blusubz/admin-dashboard.git](https://github.com/blusubz/admin-dashboard.git)